...
Read this before you upload anything. It is written in plain language on
purpose — if you don't understand a term, don't agree to it.

---

## 1. What this site is, stated bluntly

TrueHumanNature shows your photograph to strangers and asks them to judge you.
They compare your face against other people's and pick who they find more
attractive. They guess things about you from your face. They answer questions
about you that are deliberately unkind, including whether they would abandon you
and whether they would cheat on a partner for you.

We then show you the results, including **rankings, percentages, and conclusions
that many people find upsetting** — for example your position in a ranked list of
all users, how many people passed you over, and how far your opinion of yourself
differs from theirs.

**This is the product. It is not a bug, and it is not something we will soften
because you dislike your result.** If being judged harshly by anonymous strangers
...
You must be at least 18 years old to use TrueHumanNature. There are no
exceptions and no supervised or minor accounts.

If you are under 18, you may not create an account, upload a photograph, or use
any part of the service. If we believe an account belongs to a minor we will
terminate it and delete the photograph without notice.

If you believe a photograph of a minor is on the service, email
[CONTACT_EMAIL] immediately with any identifying detail you have. We treat these
reports ahead of everything else.
...
Every photograph is **reviewed by a human before anyone else sees it**. Nothing
you upload appears to other users until we approve it.

You may only upload a photograph that:

- **is of you**, taken recently, showing your own face;
- **you own or have the right to use**;
- **contains no one else**, unless they are cropped or blurred beyond
  recognition;
- **contains no nudity and nothing sexually explicit** (ordinary swimwear is
  fine);
- **contains no minors, at all, in any capacity**;
- is not a photograph of a celebrity, a stock image, or an AI-generated face.

We reject anything that fails these rules. We may reject a photograph for any
other reason, or none. If we reject one, we delete the file.

If you repeatedly upload prohibited material, or upload anything sexual
involving a minor, we terminate your account permanently and report it to the
appropriate authorities.

## 5. What you allow us to do with your photograph

By uploading a photograph you give us a **non-exclusive, worldwide,
royalty-free licence** to store it, process it, and display it to other
signed-in users of TrueHumanNature, for the purpose of operating the service.
That licence lasts only as long as the photograph is on the service.

**What this licence does not include** — and we want to be precise, because
these are the things people worry about:

- We do not sell your photograph.
- We do not licence it to advertisers or third parties.
- We do not use it in advertising or marketing for TrueHumanNature.
- We do not perform face recognition on it, generate a faceprint or face
  geometry from it, or use it to identify you anywhere else.
- We do not use it to train machine-learning models.

Your photograph is shown only inside the rating features, only to users who are
signed in, and only through links that expire. It is never published on the open
web and never indexed by search engines. The one exception you should assume is
real: **another user can take a screenshot of anything shown to them.** We
cannot prevent that, and neither can anyone else.

You keep ownership of your photograph. Delete it and the licence ends.

## 6. What other users see about you

- **The rating pool is anonymous.** Strangers rating you see your photograph and
  your age. They do not see your name, your email, your socials, or your
...
- impersonate anyone;
- try to identify, contact, follow or harass another user, on or off the site;
- screenshot, save, scrape, or republish another user's photograph anywhere;
- use bots, scripts, or automated tools against the service;
- attempt to break, overload, or gain unauthorised access to any part of it;
- resell access, credits, or data from the service.

Scraping or republishing other users' photographs is the most serious of these.
We rate-limit and log photograph access, and we terminate accounts for it.

## 8. Credits

- Credits are a **limited, revocable licence to use features of the service**.
  They are not money, not currency, not a stored-value instrument, and not
  property. They have no cash value.
- Credits are earned by using the site or bought with money.
- **Purchased credits are non-refundable**, except where a refund is required by
  applicable consumer-protection law — in which case you get that refund, and
  this clause does not limit your statutory rights.
- Credits cannot be transferred, sold, or exchanged for money.
- We may change what credits cost and what they buy. We will not reduce credits
  you have already purchased and not yet spent.
- If we terminate your account for breaching these terms, unspent credits are
  forfeited. If we close your account for any other reason, or shut the service
  down, we will refund unspent **purchased** credits.
- We never charge you on a recurring basis without telling you clearly first,
...
**We** can suspend or terminate your account if you breach these terms, if we
...
- **Photographs of minors, or sexual content involving minors** — we act
  immediately and remove first, investigate after.
- **Your own photograph uploaded by someone else, or an intimate image shared
  without your consent** — we remove it within **24 hours** of confirming your
...
In particular, **the ratings, scores, rankings and percentages this site
produces are opinions collected from anonymous strangers**. They are not facts
about you, not professional assessments of any kind, and not advice. The Human
Nature score is entertainment, not a psychological instrument. Do not make
decisions about your life based on them.
...
We are not liable for indirect or consequential losses, lost profits, or
...
You will not be able to keep using the service without accepting it; if you
don't want to, close your account instead.
...
jurisdiction of the courts of [PROVINCE], except that either of us may seek
injunctive relief anywhere.
...
*By creating an account you confirm that you are at least 18 years old, that you
have read these terms, and that you agree to them.*
